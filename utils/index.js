export const mobileCheck = () => {
  ...
  (function (a) {
    if (
      /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|Android|webOS|iPhone|iPad|iPod|IEMobile|Opera Mini|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(
        a
      ) ||
...
export const convertYouTubeDuration = function (duration = this) {
  ...
  return new Date(ms).toISOString().slice(11, -1).split('.')[0];
};
String.prototype.toHHMMSS = convertYouTubeDuration;
